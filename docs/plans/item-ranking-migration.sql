    ...
    SELECT slots.slot_name AS slot,
      ...
      FROM shared_builds sb,
           LATERAL (VALUES
             ...
             ('weapon',                 'item', COALESCE((sb.model->>'weapon')::int, 0)),
             ('leftWeapon',             'item', COALESCE((sb.model->>'leftWeapon')::int, 0)),
             ('shield',                 'item', COALESCE((sb.model->>'shield')::int, 0)),
             ('headUpper',              'item', COALESCE((sb.model->>'headUpper')::int, 0)),
             ('headMiddle',             'item', COALESCE((sb.model->>'headMiddle')::int, 0)),
             ('headLower',              'item', COALESCE((sb.model->>'headLower')::int, 0)),
             ('armor',                  'item', COALESCE((sb.model->>'armor')::int, 0)),
             ('garment',                'item', COALESCE((sb.model->>'garment')::int, 0)),
             ('boot',                   'item', COALESCE((sb.model->>'boot')::int, 0)),
             ('accLeft',                'item', COALESCE((sb.model->>'accLeft')::int, 0)),
             ('accRight',               'item', COALESCE((sb.model->>'accRight')::int, 0)),
             ('ammo',                   'item', COALESCE((sb.model->>'ammo')::int, 0)),
             ('pet',                    'item', COALESCE((sb.model->>'pet')::int, 0)),
             ('costumeEnchantUpper',    'item', COALESCE((sb.model->>'costumeEnchantUpper')::int, 0)),
             ('costumeEnchantMiddle',   'item', COALESCE((sb.model->>'costumeEnchantMiddle')::int, 0)),
             ('costumeEnchantLower',    'item', COALESCE((sb.model->>'costumeEnchantLower')::int, 0)),
             ('costumeEnchantGarment',  'item', COALESCE((sb.model->>'costumeEnchantGarment')::int, 0)),
             ('shadowWeapon',           'item', COALESCE((sb.model->>'shadowWeapon')::int, 0)),
             ('shadowArmor',            'item', COALESCE((sb.model->>'shadowArmor')::int, 0)),
             ('shadowShield',           'item', COALESCE((sb.model->>'shadowShield')::int, 0)),
             ('shadowBoot',             'item', COALESCE((sb.model->>'shadowBoot')::int, 0)),
             ('shadowEarring',          'item', COALESCE((sb.model->>'shadowEarring')::int, 0)),
             ('shadowPendant',          'item', COALESCE((sb.model->>'shadowPendant')::int, 0)),
             -- Card slots (type = 'card')
             ('weapon',    'card', COALESCE((sb.model->>'weaponCard1')::int, 0)),
             ('weapon',    'card', COALESCE((sb.model->>'weaponCard2')::int, 0)),
             ('weapon',    'card', COALESCE((sb.model->>'weaponCard3')::int, 0)),
             ('weapon',    'card', COALESCE((sb.model->>'weaponCard4')::int, 0)),
             ('leftWeapon','card', COALESCE((sb.model->>'leftWeaponCard1')::int, 0)),
             ('leftWeapon','card', COALESCE((sb.model->>'leftWeaponCard2')::int, 0)),
             ('leftWeapon','card', COALESCE((sb.model->>'leftWeaponCard3')::int, 0)),
             ('leftWeapon','card', COALESCE((sb.model->>'leftWeaponCard4')::int, 0)),
             ('shield',    'card', COALESCE((sb.model->>'shieldCard')::int, 0)),
             ('headUpper', 'card', COALESCE((sb.model->>'headUpperCard')::int, 0)),
             ('headMiddle','card', COALESCE((sb.model->>'headMiddleCard')::int, 0)),
             ('armor',     'card', COALESCE((sb.model->>'armorCard')::int, 0)),
             ('garment',   'card', COALESCE((sb.model->>'garmentCard')::int, 0)),
             ('boot',      'card', COALESCE((sb.model->>'bootCard')::int, 0)),
             ('accLeft',   'card', COALESCE((sb.model->>'accLeftCard')::int, 0)),
             ('accRight',  'card', COALESCE((sb.model->>'accRightCard')::int, 0))
